function setup() {
	...
	textSize(20);
	textFont("Calibri",24);
	text("Keep clicking for flowery inspo",
		120, 20, width - 40, height - 40);
}
...
function mousePressed(){
	...
	var output = grammar.flatten("#sentence#");
...
var randomSentence = {
  "sentence": [
    "There is nothing quite like #flowers.capitalize.a#, its #colors# #flowerPart# and its #colors# #flowerPart# to #brighten# the #day#. Whether #occupation# or #occupation#, a flower should always be #part# the home. Who #not# to #enjoy# such #beauty#?"
  ],
  "often": [
    "rarely",
    "never",
